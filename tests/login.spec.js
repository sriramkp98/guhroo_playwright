...
//To check the field validations(Error messages) for login page 
  ...
  var expectedresult_username = 'Please enter your username to proceed.';
  var expectedresult_password = 'Please enter your password to proceed.';
  if(expectedresult_username === actualresult_username && expectedresult_password===actualresult_password){
    console.log("Logging in without giving an username and password: ", actualresult_username, "," , actualresult_password)
  }
  else{
    console.log("Logging in without giving an username and password: ", actualresult_username, "," , actualresult_password)
  }
  ...
  var expectedresult_username1= 'You have entered a invalid username';
  if(expectedresult_username1 === actualresult_username1 ){
    console.log("Giving an empty space for username field: ", actualresult_username1)
  }
  else{
    console.log("Giving an empty space for username field:", actualresult_username1)
  }
 ...
 //Giving a valid username and invalid password
  ...
  const password2= page.locator('//*[@id="root"]/div[1]/div/section/div/div/div/div/div/form/div[2]/div/div');
  var actualresult_password2 = await password2.textContent();
  var expectedresult_password2= 'The password you entered is incorrect';
  if(actualresult_password2 === expectedresult_password2 ){
    console.log("Giving a valid username and invalid password: ", actualresult_password2)
  }
  else{
    console.log("Giving a valid username and invalid password:", actualresult_password2)
  }
  ...
  var expectedresult_invalid_usernamepassword= 'Oops! Unable to process your request. Please check the data and try again.';
  if(actualresult_invalid_usernamepassword === expectedresult_invalid_usernamepassword ){
    console.log("Giving a invalid username and invalid password: ", actualresult_invalid_usernamepassword)
  }
  else{
    console.log("Giving a invalid username and invalid password:", actualresult_invalid_usernamepassword)
  }
  ...
  var expectedresult_invalid_username= 'Please enter your username to proceed.';
  if(actualresult_invalid_username === expectedresult_invalid_username ){
    console.log("Requesting a forgot password link without giving an username: ", actualresult_invalid_username)
  }
  else{
    console.log("Requesting a forgot password link without giving an username:", actualresult_invalid_username)
  }
  ...
  var expectedresult_invalid_username1= 'Invalid Username';
  if(actualresult_invalid_username1 === expectedresult_invalid_username1 ){
    console.log("Requesting a forgot password link by giving an invalid username: ", actualresult_invalid_username1)
  }
  else{
    console.log("Requesting a forgot password link by giving an invalid username: ", actualresult_invalid_username1)
  }
  ...
  var expectedresult_invalid_username2= 'Invalid Username';
  if(actualresult_invalid_username2 === expectedresult_invalid_username2){
    console.log("Requesting a forgot password link by giving an valid mail in username: ", actualresult_invalid_username2)
  }
  else{
    console.log("Requesting a forgot password link by giving an valid mail in username: ", actualresult_invalid_username2)
  }
  ...
  var expectedresult_invalid_username3= 'Validation Error';
  if(actualresult_invalid_username3 === expectedresult_invalid_username3){
    console.log("Requesting a forgot password link by giving an empty space in username: ", actualresult_invalid_username3)
  }
  else{
    console.log("Requesting a forgot password link by giving an empty space in username: ", actualresult_invalid_username3)
  }
  ...
  var expectedresult_valid_username= 'Reset string generated successfully';
  if(actualresult_valid_username === expectedresult_valid_username){
    console.log("Requesting a forgot password link by giving a valid username in username: ", actualresult_valid_username)
  }
  else{
    console.log("Requesting a forgot password link by giving a valid username in username: ", actualresult_valid_username)
  }
  ...
  var expectedresult_invalid_passwordandconfirm= 'Validation Error';
  if(actualresult_invalid_passwordandconfirm === expectedresult_invalid_passwordandconfirm){
    console.log("Giving an empty space in password and confirm password: ", actualresult_invalid_passwordandconfirm)
  }
  else{
    console.log("Giving an empty space in password and confirm password: ", actualresult_invalid_passwordandconfirm)
  }
  ...
  var expectedresult_invalid_password= 'Password field is required';
  var expectedresult_invalid_confirm= 'Password field is required';
  if(actualresult_invalid_password === expectedresult_invalid_password && actualresult_invalid_confirm===expectedresult_invalid_confirm){
    console.log("Clicking on change password button without giving password and confirm password: ", actualresult_invalid_password, ",", actualresult_invalid_confirm)
  }
  else{
    console.log("Clicking on change password button without giving password and confirm password: ", actualresult_invalid_password, ",", actualresult_invalid_confirm)
  }
  ...
  if(actualresult_invalid_passwordandconfirm2 === expectedresult_invalid_passwordandconfirm2){
    console.log("Clicking on change password button by giving a character in password and confirm password: ", actualresult_invalid_passwordandconfirm2)
  }
  else{
    console.log("Clicking on change password button by giving a character in password and confirm password: ", actualresult_invalid_passwordandconfirm2)
  }
  ...
  var expectedresult_invalid_passwordandconfirm3= 'Validation Error';
  if(actualresult_invalid_passwordandconfirm3 === expectedresult_invalid_passwordandconfirm3){
    console.log("Clicking on change password button by giving a character and special character in password and confirm password: ", actualresult_invalid_passwordandconfirm3)
  }
  else{
    console.log("Clicking on change password button by giving a character and special character in password and confirm password: ", actualresult_invalid_passwordandconfirm3)
  }
  ...
  var expectedresult_valid_username_pinvalid_password= 'The password you entered is incorrect';
  if(actualresult_valid_username_pinvalid_password === expectedresult_valid_username_pinvalid_password){
    console.log("Entering the previous password with correct username: ", actualresult_valid_username_pinvalid_password)
  }
  else{
    console.log("Entering the previous password with correct username: ", actualresult_valid_username_pinvalid_password)
  }
  ...
  await page1.getByPlaceholder('Enter password').fill('Password@567');
  await page1.getByRole('button', { name: 'Sign in' }).click();
  const valid_username_pinvalid_password1= page1.locator('//*[@id="root"]/div[1]/div/section/div/div/div/div/div/form/div[2]/div/div');
  var actualresult_valid_username_pinvalid_password1=await valid_username_pinvalid_password1.textContent();
  var expectedresult_valid_username_pinvalid_password1= 'Oops! Unable to process your request. Please check the data and try again.';
  if(actualresult_valid_username_pinvalid_password1 === expectedresult_valid_username_pinvalid_password1){
    console.log("Giving a valid mail id in username field and valid password: ", actualresult_valid_username_pinvalid_password1)
  }
  else{
    console.log("Giving a valid mail id in username field and valid password: ", actualresult_valid_username_pinvalid_password1)
  }
